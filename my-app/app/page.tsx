        ...
        <div className="container mx-auto px-4 mb-16">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our intuitive drag-and-drop interface makes it easy to build, test, and deploy AI pipelines without
              writing a single line of code.
            </p>
          </div>

          <div className="rounded-xl overflow-hidden border border-border shadow-xl h-[600px]">
            <PipelineBuilder />
          </div>
        </div>
      </section>
      ...
      <footer className="bg-secondary/30 py-12 border-t border-border">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold">AI Pipeline Builder</span>
              </div>
              <p className="text-muted-foreground mt-2 max-w-md">
                Build powerful AI pipelines with our intuitive drag-and-drop interface.
              </p>
            </div>
          ...
          <div className="border-t border-border mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm">© 2025 AI Pipeline Builder. All rights reserved.</p>
